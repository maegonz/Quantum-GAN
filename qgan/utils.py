...
def draw_circuit(circuit, n_layers, n_qubits):
    weights = jnp.zeros((n_layers, n_qubits, 3))
    noise = jnp.zeros(n_qubits)

    fig, ax = qml.draw_mpl(circuit)(weights, noise, n_layers=n_layers, n_qubits=n_qubits)
    plt.show()