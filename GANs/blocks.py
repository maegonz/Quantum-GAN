...
class GenBlock(nn.Module):
    def __init__(self, in_channels, out_channels, stride=2, padding=1, out_padding=0, biais=False, **kwargs):
        """
        ...
        **kwargs
        ...
        self.conv = nn.ConvTranspose2d(in_channels, out_channels, kernel_size=4, stride=stride, padding=padding, output_padding=out_padding, bias=biais, **kwargs)
...
class DiscBlock(nn.Module):
    def __init__(self, in_channels, out_channels, stride=2, padding=1, **kwargs):
        """
        ...
        **kwargs
        ...
        self.conv = nn.Conv2d(in_channels, out_channels, kernel_size=4, stride=stride, padding=padding, bias=True, **kwargs)
